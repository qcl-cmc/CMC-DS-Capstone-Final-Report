...
\usepackage{longtable} % For tables taking up more than one page     
...
\include{technical_writing_tips}

%%% Chapter 4

\include{creating_figures}

%%% Chapter 5

\include{equation_etiquette}

%%% Chapter 6

\include{formatting_your_bibliography}
...
% Here we use acm bibliography-style as an example.
